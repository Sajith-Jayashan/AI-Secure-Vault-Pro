...
- **AWS Services**: S3, Lambda, API Gateway, DynamoDB, Rekognition, Cognito, CloudFront
...
## ✍️ Author
**Mahanama Pathiranalage Sajith Jayashan Rathnayaka**
*University Student & Cloud Enthusiast*
